...
public class OSMTags {
	...
	public static final String TRAIN_STATION_TAG_VALUE = "train_station";
	public static final String SHELTER_TYPE_TAG = "public_transport";
	public static final String PUBLIC_TRANSPORT_TAG_VALUE = "public_transport";

	public static final String BUS_STOP_TAG_VALUE = "bus_stop";
	public static final String BUS_STATION_TAG_VALUE = "bus_station";
	public static final String FERRY_TERMINAL_TAG_VALUE = "ferry_terminal";
	...
	public static final String STOP_TAG_VALUE = "stop";
	...
	public static final String STAIRS_TAG_VALUE = "stairs";
	public static final String STAIRWELL_TAG_VALUE = "stairwell";
	...
	public static final String FOOTWAY_TAG = "footway";
	public static final String SIDEWALK_TAG_VALUE = "sidewalk";
	public static final String PEDESTRIAN_TAG_VALUE = "pedestrian";
